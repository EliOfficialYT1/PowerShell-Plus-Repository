...
def WindowsCustom7Shell():
    while True:
        ...
        if UserPowershell7Input == 'GetPnp - Version':
            ...
            print("GetPnp - EnterColorEditor > Allow's For Color Changes!"), print(), print('=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-'),print(),print("GetPnp - EnterColorEditor - Enchanted > More Advanced Color Options."),print()
